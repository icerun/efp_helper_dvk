...
public class GitMrUi extends DialogWrapper {
    ...
    private String getBranceName(GitProjectInfo gitProjectInfo, String preBranceName) {
        if (preBranceName.startsWith("应用名-")) {
            return preBranceName.replace("应用名-", gitProjectInfo.getProjectName().toLowerCase());
        }
        return preBranceName;
    }

    private String getBranceName(AppInfo appInfo, String preBranceName) {
        if (preBranceName.startsWith("应用名-")) {
            return preBranceName.replace("应用名-", appInfo.getProjectName().toLowerCase());
        }
        return preBranceName;
    }
